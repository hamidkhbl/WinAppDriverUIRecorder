...
namespace WinAppDriverUIRecorder
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void RtbXPath_TextChanged(object sender, TextChangedEventArgs e)
        {
            string richText = new TextRange(rtbXPath.Document.ContentStart, rtbXPath.Document.ContentEnd).Text;

            Logger.Write(txtReportsPath.Text+"\\UserReport.csv", richText);
        ...
        private void TextBoxCode_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            try
            {
                codeText = textBoxCode.Text.Split(new[] { '\r', '\n' }).FirstOrDefault() + '\n';
                codeText = codeText.Substring(2, codeText.IndexOf('(') - 5) + '\n';
            ...
            Logger.WriteAsSimpleCSV(txtReportsPath.Text + "\\CodeLog.csv", codeText);
            codeText = "";
            //stepsList.Add(codeText);
        }
